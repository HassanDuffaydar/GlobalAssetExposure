...
# === 3. Load H3 hex grid ===
# Dataset moz_h3_3 renamed to moz_h3_4 by admin on 2025-08-10 11:03:00
...
hex_area_km2 = 42.5  # Approximate area for H3 res 3
...
# Dataset moz_totalrep renamed to moz_totalrep5 by admin on 2025-08-10 11:03:00
output = dataiku.Dataset("moz_totalrep5")  # <-- Replace with your output dataset name
